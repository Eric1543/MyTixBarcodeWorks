...
class CreateNewEvent extends React.Component{
  ...
  handleOptionSubmit(event) {
		...
		handleEventSubmit(event){
			...
			// console.log(this.state)
			this.props.makeNewEvent(this.state.newEventName, this.state.newEventStart, this.state.newEventEnd, this.state.newEventLocation,this.state.newEventPicture, this.props.customers, this.props.options)
			console.log("================")
